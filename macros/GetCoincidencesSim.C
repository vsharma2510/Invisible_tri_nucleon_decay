...
int main()
{
  ...
  TFile* sim_file = TFile::Open("../simulation_output/127In_decay_coincidence_test.root");
  ...
  int channel,multiplicity,multi_index; //Channel number, Multiplet Index
  ...
  sim_tree->SetBranchAddress("Coincidence@Multiplicity",&multiplicity);
  ...
  sim_tree->SetBranchAddress("Resolution@Energy",&energy);
